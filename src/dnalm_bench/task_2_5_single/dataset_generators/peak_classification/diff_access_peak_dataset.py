...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Given a file of differentially accessible peaks, changes the format to the desired one"
    )
    parser.add_argument(
        "--input_file",
        type=str,
        required=True,
        help="File with differentially accessible peaks for each dataset",
    )
