...
out_file = os.path.join(
    root_output_dir,
    f"task_4_chromatin_activity/supervised_model_outputs/chrombpnet/{cell_line}_metrics.json",
)


print("Loading Datasets")
pos_peak_dataset = ChromBPNetPeakDataset(
    peaks_tsv, bigwig_file, genome_fa, chroms_test, batch_size
)
neg_peak_dataset = ChromBPNetPeakDataset(
    nonpeaks_tsv, bigwig_file, genome_fa, chroms_test, batch_size
)
idr_peak_dataset = ChromBPNetPeakDataset(
