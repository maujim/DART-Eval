...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Collects arguments to run GC matching using the ChromBPNet Multitask repo"
    )
...
def run_matching(
    peak_file, chrom_size_file, genome_file, output_dir, blacklist, input_len, stride
):
